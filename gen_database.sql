...
create table covers (
  contract varchar(12),
  diagnosis_code varchar(10),
  primary key (contract, diagnosis_code),
  foreign key (contract) references contract(contract_id),
  foreign key (diagnosis_code) references diagnosis_code(code)
);
...
(0392857191, '2018-03-01', 45, '2018-03-31', 30, '2018-04-15','Amoxicillin', 123456789, 0000000432),
(0392852845, '2018-03-01', 30, '2018-03-16', 15,  '2018-03-31','Viagra', 123456789, 0000000432),
(0392820384, '2018-02-05', 15, null, 60, '2018-02-20','Z-Pak', 123204357, 0000000433),
(0357483845, '2018-01-15', 15, null, 45, '2018-01-30','Z-Pak', 932847219, 0000005343),
(0392832954, '2017-11-01', 45, '2017-11-20', 180, '2017-12-15','Codeine', 967483789, 0000000633),
(0392958425, '2018-08-01', 20, '2018-08-10', 200, '2017-08-30','Adderall', 19302357, 0000000433),
(0954832384, '2017-09-05', 30, '2017-09-20', 150, '2017-10-05','Metformin', 923416789, 0000000633),
(0940343845, '2018-04-10', 20, '2018-04-20', 10, '2018-04-30','Codeine', 123413548, 0000000433),
(0493029384, '2018-04-15', 15, null, 30, '2018-04-30','Hydrochlorothiazide', 123204357, 0000000433),
(0349239214, '2018-01-15', 25, null, 25, '2018-02-09','Z-Pak', 932847219, 0000005343);
